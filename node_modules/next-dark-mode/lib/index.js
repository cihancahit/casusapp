...
var darkmodejs_1 = __importDefault(require("@assortment/darkmodejs"));
...
exports.NextDarkModeContext = react_1.createContext({
    autoModeActive: true,
...
exports.NextDarkModeContext.displayName = 'NextDarkMode';
exports.default = (function (App, config) {
    var mergedConfig = __assign(__assign({}, defaultConfig), config);
    var autoModeCookieName = mergedConfig.autoModeCookieName, darkModeCookieName = mergedConfig.darkModeCookieName, defaultMode = mergedConfig.defaultMode;
    function NextDarkMode(_a) {
        var initialProps = _a.initialProps, props = __rest(_a, ["initialProps"]);
        var _b = react_1.useState({
            ...
            switchToAutoMode: function () {
                setState(function (state) {
                    if (state.autoModeSupported) {
                        nookies_1.setCookie(null, autoModeCookieName, '1', {});
                        var darkModeActive = state.browserMode === MODE.DARK;
                        nookies_1.setCookie(null, darkModeCookieName, darkModeActive ? '1' : '0', {});
            ...
            switchToDarkMode: function () {
                ...
                nookies_1.setCookie(null, autoModeCookieName, '0', {});
                nookies_1.setCookie(null, darkModeCookieName, '1', {});
            },
            switchToLightMode: function () {
                setState(function (state) { return (__assign(__assign({}, state), { autoModeActive: false, darkModeActive: false })); });
                nookies_1.setCookie(null, autoModeCookieName, '0', {});
                nookies_1.setCookie(null, darkModeCookieName, '0', {});
            },
        }), state = _b[0], setState = _b[1];
        react_1.useEffect(function () {
            var removeListeners = darkmodejs_1.default({
                        ...
                        case themes.DARK:
                            setState(function (state) {
                                if (state.autoModeSupported) {
                                    ...
                                    return __assign(__assign({}, state), { autoModeSupported: true, browserMode: MODE.DARK });
                            });
                            break;
                        case themes.LIGHT:
                            setState(function (state) {
                                if (state.autoModeSupported) {
                                    ...
                                    return __assign(__assign({}, state), { autoModeSupported: true, browserMode: MODE.LIGHT });
                            });
                            break;
                        case themes.NO_PREF:
                        case themes.NO_SUPP:
        ...
        return (react_1.default.createElement(exports.NextDarkModeContext.Provider, { value: state },
            react_1.default.createElement(App, __assign({}, props, initialProps))));
    }
    NextDarkMode.getInitialProps = function (_a) {
        var Component = _a.Component, ctx = _a.ctx;
        return __awaiter(void 0, void 0, void 0, function () {
            var initialProps, _b, cookies, autoModeCookie, darkModeCookie, autoMode, darkMode, autoModeString, darkModeString;
                    ...
                    case 3:
                        ...
                        if (typeof window === 'undefined') {
                            ...
                            if (autoModeString !== autoModeCookie)
                                nookies_1.setCookie(ctx, autoModeCookieName, autoModeString, {});
                            if (darkModeString !== darkModeCookie)
                                nookies_1.setCookie(ctx, darkModeCookieName, darkModeString, {});
